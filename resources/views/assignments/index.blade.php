...
<div class="flex justify-between items-center mb-6">
  ...
  <a href="{{ route('assignments.create') }}" class="inline-block px-6 py-2 bg-blue-600 text-blue font-medium rounded-lg hover:bg-blue-700 transition">Nueva Asignación</a>
