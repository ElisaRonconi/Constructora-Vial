...
<div class="max-w-lg mx-auto bg-white p-6 shadow rounded-lg">
  ...
  <form action="{{ route('machines.update', $machine) }}" method="POST" class="space-y-4">
    ...
    <div>
      ...
      <input type="text" name="id_type" value="{{ old('id_type', $machine->id_type) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
    </div>
    <div>
