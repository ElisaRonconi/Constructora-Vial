...
<div class="flex justify-between items-center mb-6">
  ...
  <a href="{{ route('works.create') }}" class="inline-block px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition">Nueva Máquina</a>
</div>
  ...
  <table class="min-w-full table-auto">
    ...
    <tbody>
      ...
      <tr class="border-t hover:bg-gray-50 transition {{ $loop->odd ? 'bg-white' : 'bg-gray-100' }}">
        ...
        <td class="px-6 py-4 whitespace-nowrap">{{ $work->id_province }}</td>
